...
sealed class ApiResponse<out T> {
    ...
    * */
    ...
    companion object {
        ...
        * If [retrofit2.Response] h  as no errors, it creates [ApiResponse.ApiSuccessResponse]
        * If [retrofit.Response] has errors, it creates [ApiResponse.ApiFailureResponse.Error]
        * If [retrofit.Response] has occured exceptions, it creates [ApiResponse.ApiFailureResponse.Exception]
        *
        * */
